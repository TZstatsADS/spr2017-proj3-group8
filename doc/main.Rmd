...
# # If files exist, load them. If not, comment out section
# # ----------------------------------------------------------------------------
...
# If running above section, comment out this section
#------------------------------------------------------------------------------
...
# Put data into format for model (train/test - 1600/400 images)
#-------------------------------------------------------------------------------
...
# Put data into format for model (FULL - all 2000 images)
#------------------------------------------------------------------------------
...
# Load the CNN train and test functions
#-------------------------------------------------------------------------------
source("../lib/Conv_Neural_Net/mxnet_train_test_cv.R")

# train model on 80% dataset for validation
cnn_train(train_x = train_x, train_y = train_y, output_model_name = CNN_train)

## load model if available, if not comment out
# model <- mx.model.load(prefix = "../../output/mxnet_model", iteration = 1)

# test on 20% dataset to calculate out-of-sample error rate
cnn_test(model, test_array, saveFile = T)



# train on 100% dataset for competition
cnn_train(train_x = train_FULL_x, train_y = train_FULL_y, 
          output_model_name = CNN_FULL_train)
```

### Prediction
```{r}
## Comment out until we get the test data
# test(dat_test)
```
